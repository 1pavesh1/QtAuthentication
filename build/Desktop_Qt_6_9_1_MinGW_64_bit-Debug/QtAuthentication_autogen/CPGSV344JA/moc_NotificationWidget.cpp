...
#include "../../../../QtAuthentication/CustomWidgets/Widgets/NotificationWidget.h"
...
void *NotificationWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "CommonCustomWidgetInterface"))
        return static_cast< CommonCustomWidgetInterface*>(this);
